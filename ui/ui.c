...
lv_label_set_text(ui_question,"Select Button 1 on the first screen. ehiwehfifwefiojwo");
...
lv_obj_set_style_text_font(ui_question, &lv_font_montserrat_10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_label_set_text(ui_answer,"As an artificial intelligence language \nmodel,  I don't exist in a physical location. \nI'm a software program running on servers \nhosted by OpenAI, which can be accessed \nthrough various platforms and applications.");
